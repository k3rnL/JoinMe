...
//                 <ImageBackground style={{left: 0, right: 0, top: 0, bottom: 0, height: 400}} source={{uri: preview}} onLoad={console.log('LOL' + preview)}>
//                     <LinearGradient
//                         start={rgba(1,1,1, 0)}
//                         end={rgba(1,1,1, 1)}
...
//     constructor(props) {
//         super(props);
//         let party = this.props.navigation.getParam('party', null);
//         this.state = {
//             party,
